...
"}")
        ...
        self.verticalSlider = QtWidgets.QSlider(self.splineDetails)
        self.verticalSlider.setGeometry(QtCore.QRect(10, 120, 20, 131))
        self.verticalSlider.setAutoFillBackground(False)
        self.verticalSlider.setStyleSheet("QSlider::handle:vertical {\n"
"    background: rgb(241, 0, 109);\n"
"    \n"
" border-radius: 10px;\n"
"  \n"
"}\n"
...
"}")
        ...
        self.lcdNumber = QtWidgets.QLCDNumber(self.splineDetails)
        self.lcdNumber.setGeometry(QtCore.QRect(40, 140, 51, 23))
        self.lcdNumber.setStyleSheet(" color: rgb(44, 44, 44);  background-color: rgb(252, 17, 125);")
        self.lcdNumber.setObjectName("lcdNumber")
        self.degreeLabel = QtWidgets.QLabel(self.splineDetails)
        self.degreeLabel.setGeometry(QtCore.QRect(10, 100, 60, 16))
