...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color:rgb(62, 62, 62); color:rgb(130, 130, 130)")
...
"}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/eraseWhite.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.controlPointsCheckBox = QtWidgets.QCheckBox(self.centralWidget)
        self.controlPointsCheckBox.setStyleSheet("QCheckBox{\n"
"color: rgb(255, 255, 255);\n"
"margin:5px;\n"
"}\n"
"QCheckBox::indicator \n"
...
"    color: rgb(0, 0, 0);\n"
"}")
        self.controlPointsCheckBox.setObjectName("checkBox")
        self.gridLayout.addWidget(self.controlPointsCheckBox, 1, 4, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.editCheckBox, 1, 6, 1, 1)
        spacerItem2 = QtWidgets.QSpacerItem(1, 1, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        ...
        self.splineDetails.setMinimumSize(QtCore.QSize(150, 0))
        self.splineDetails.setStyleSheet("border-color: rgb(255, 255, 255);")
...
"}")
        ...
        self.DoneButton = QtWidgets.QPushButton(self.splineDetails)
        self.DoneButton.setGeometry(QtCore.QRect(20, 510, 80, 24))
...
"}")
        ...
        self.radioButtonLinearDegree = QtWidgets.QRadioButton(self.splineDetails)
        self.radioButtonLinearDegree.setGeometry(QtCore.QRect(10, 110, 100, 22))
        self.radioButtonLinearDegree.setAutoFillBackground(False)
        self.radioButtonLinearDegree.setStyleSheet("\n"
"")
        # self.radioButtonLinearDegree.setChecked(True)
        self.radioButtonLinearDegree.setObjectName("radioButtonLinearDegree")
        self.radioButtonQuadraticDegree = QtWidgets.QRadioButton(self.splineDetails)
        self.radioButtonQuadraticDegree.setGeometry(QtCore.QRect(10, 140, 100, 22))
        self.radioButtonQuadraticDegree.setObjectName("radioButtonQuadraticDegree")
        self.radioButtonCubicDegree = QtWidgets.QRadioButton(self.splineDetails)
        self.radioButtonCubicDegree.setGeometry(QtCore.QRect(10, 170, 100, 22))
        self.radioButtonCubicDegree.setObjectName("radioButtonCubicDegree")
        self.radioButtonQuinticDegree = QtWidgets.QRadioButton(self.splineDetails)
        self.radioButtonQuinticDegree.setGeometry(QtCore.QRect(10, 200, 100, 22))
        self.radioButtonQuinticDegree.setObjectName("radioButtonQuinticDegree")
        self.radioButtonSepticDegree = QtWidgets.QRadioButton(self.splineDetails)
        self.radioButtonSepticDegree.setGeometry(QtCore.QRect(10, 230, 100, 22))
        self.radioButtonSepticDegree.setObjectName("radioButtonSepticDegree")
        self.label = QtWidgets.QLabel(self.splineDetails)
        self.label.setGeometry(QtCore.QRect(10, 270, 60, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.controlPointsCheckBox.setText(_translate("MainWindow", "Show Control Points"))
        self.undoButton.setText(_translate("MainWindow", "Undo"))
        self.editCheckBox.setText(_translate("MainWindow", "Edit"))
        self.splineDetails.setTitle(_translate("MainWindow", "Spline Settings"))
        ...
        self.radioButtonLinearDegree.setText(_translate("MainWindow", "1 Linear"))
        self.radioButtonQuadraticDegree.setText(_translate("MainWindow", "2 Quadratic"))
        self.radioButtonCubicDegree.setText(_translate("MainWindow", "3 Cubic"))
        self.radioButtonQuinticDegree.setText(_translate("MainWindow", "5 Quintic"))
        self.radioButtonSepticDegree.setText(_translate("MainWindow", "7 Septic"))
