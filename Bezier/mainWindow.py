...
class MainWindow(Ui_MainWindow):
    ...
    def __init__(self,window):
        ...
        self.openGLWidget.setCuverType(self.SelectComboBox.currentText())
        self.SelectComboBox.activated[str].connect(self.openGLWidget.setCuverType)
    ...
    def pop(self):
        ...
        if len(stack) > 0:
            ...
            if len(self.openGLWidget.history) > 0 and self.popClicks == 3:
